...
def main():
    ...
    batch_size = 100
    (_, data_loader) = dataset.getDataloaders(batch_size)

    print('Extract features')
    tst_data_rep, tst_data_cls_rep, tst_labels_rep = meta_utils.extract_features(data_loader, model, train_classes_idx, device)
