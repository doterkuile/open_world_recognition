#!/bin/bash
#SBATCH --job-name=train_l2ac_efficientnet 	# create a short name for your job
...
# Loop variables
var_1=name	
array_1=(l_t_efnet_0004)
var_2=top_n
array_2=(9)
var_3=l2ac_train
array_3=(80)
var_4=model_class
array_4=(L2AC_extended_similarity)
var_5=top_k
array_5=(15)
var_6=two_step_training
array_6=(False)
var_7=encoder
array_7=(EfficientNet)
var_8=feature_layer
array_8=(_avg_pooling)
var_9=unfreeze_layer
array_9=(30)
len=${#array_1[@]}
