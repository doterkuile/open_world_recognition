...
def main():
	...
	train_X0, train_X1, train_Y = meta_utils.rank_samples_from_memory(class_set[:num_train], data_rep, data_cls_rep, classes, train_per_cls, top_k)
	valid_X0, valid_X1, valid_Y = meta_utils.rank_samples_from_memory(class_set[-num_valid:], data_rep, data_cls_rep, classes, train_per_cls, top_k)
